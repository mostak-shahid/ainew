<?php
function ainew_metaboxes() {
    $prefix = '_ainew_';
    global $ainew_options,$template_parts;
    $blog_id = get_option( 'page_for_posts' );
    if ($_GET['post'] == $blog_id){
        $enabled = ($ainew_options['archive-page-sections']['Enabled']) ? $ainew_options['archive-page-sections']['Enabled'] : $template_parts['Enabled'];
        $disabled = ($ainew_options['archive-page-sections']['Disabled']) ? $ainew_options['archive-page-sections']['Disabled'] : $template_parts['Disabled'];
    }
    else{
        $enabled = ($ainew_options['general-page-sections']['Enabled']) ? $ainew_options['general-page-sections']['Enabled'] : $template_parts['Enabled'];
        $disabled = ($ainew_options['general-page-sections']['Disabled']) ? $ainew_options['general-page-sections']['Disabled'] : $template_parts['Disabled'];
    }
...
add_action('cmb2_admin_init', 'ainew_metaboxes');