...
$class = $ainew_options['sections-widgets-class'];
$title = $ainew_options['sections-widgets-title'];
$content = $ainew_options['sections-widgets-content'];
$widget_layout = $ainew_options['sections-widgets-layout'];
...
?>
<section id="section-widgets" class="<?php if(@$ainew_options['sections-widgets-background-type'] == 1) echo @$ainew_options['sections-widgets-background'] . ' ';?><?php if(@$ainew_options['sections-widgets-color-type'] == 1) echo @$ainew_options['sections-widgets-color'];?> <?php echo $class ?>">
